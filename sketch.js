...
gameOver=createSprite(799,390);
gameOver.addImage(gameOverImg);

won=createSprite(799,390);
won.addImage(wonImg);
...
function draw() {
  ...
  textSize(20);
  fill("yellow");
  text("Score: "+ score, 1440,20);
  stroke("yellow");
  textSize(20);
  fill("blue");
  text("To Control The Fighter Jet Plane Press 'Space Bar'",1080,669);
  stroke("yellow");
  textSize(20);
  fill("Green");
  text("To Control The Fighter Jet Plane Fast Press 'Up Arrow'",1040,689);
  stroke("blue");
  textSize(20);
  fill("green");
  text("To Destroy The Helicopters Press ' Enter ' To Release Missiles From Fighter Jet Plane" ,770,709);
}
